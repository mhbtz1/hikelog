        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" id="date" value={date} onChange={e => (() => {console.log(`Set date to ${e.target.value}`); setDate(e.target.value)})()} className="mt-1 block w-full bg-dark-slate border-slate-gray rounded-md shadow-sm py-2 px-3 text-stone focus:outline-none focus:ring-mint focus:border-mint" required />
                </div>
                <div>
